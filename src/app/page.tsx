    ...
    <div className="container mx-auto py-12 space-y-16">
      ...
      <section className="my-12">
        <div className="text-center">
          <a href="https://www.sketchmagic.org/" className="bg-red-500 text-white font-bold py-4 px-8 rounded text-center hover:scale-110 transition-transform duration-300">here we go</a>
        </div>
