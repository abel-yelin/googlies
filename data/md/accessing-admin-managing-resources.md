---
title: today Googlies daily puzzle durov for november 10 2024
description: How to access the admin panel and manage your resource list in Googlies
date: '2024-08-11T13:14:40.737Z'
---
# Accessing the Admin Panel and Managing Resources in Googlies

Googlies provides a user-friendly admin interface for managing your website's resources. This guide will walk you through the process of accessing the admin panel and managing your resources effectively.

## Accessing the Admin Panel

1. **Navigate to the Admin URL**: Open your web browser and go to your Googlies website's URL, followed by `/admin`. For example: `https://yourGoogliessite.com/admin`.
...
Note: The current version of Googlies might not support direct deletion through the admin interface. If you need to remove a resource:
...
Googlies automatically syncs your changes with the GitHub repository configured in your environment variables. After making changes:
...
1. **Regular Backups**: Although Googlies uses GitHub for version control, it's a good practice to periodically backup your `resources.json` file.
...
By following these steps, you should be able to effectively manage the resources on your Googlies website through the admin panel. Remember, all changes are version-controlled through GitHub, allowing you to track modifications and revert if necessary.
